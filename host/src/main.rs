...
use ethers_core::types::{Address, RecoveryMessage, Signature, H160, H256, U256};
...
fn prove_address(
    ...
    let input: (&H160, &Signature, &H256) = (signer_address, signature, digest);
...
fn main()->Result<(), Box<dyn std::error::Error>> {
    ...
    let signer_address: H160 = "0xb1df9fd903edcb315ea04ff0b60e53f2a766080e"
        .parse()?;
    ...
    let signature = Signature {
        r: "0x5f19cd73e4fb54a8d014150f02068f941fffde1a7382d94265725aa7a8c30861"
            .parse()?,
        s: "0x031ccb397e2e49c76a4e1f070c4c8ed15e59dad4857429c9bd1e8f9a9b0a0846"
            .parse()?,
        v: 27,
    };
    ...
    let receipt = prove_address(&signer_address, &signature, &digest);
    ...
    let (signer_address, signature): (H160, Signature) = receipt.journal.decode().unwrap();
    println!("hey there");

    println!("Recovered signer address: {:?}", signer_address);
